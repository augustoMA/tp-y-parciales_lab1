 ...
 */
int al_isEmpty(ArrayList* this)//13
{
    int returnAux = -1;
    int aux;
 ...
 */
void* al_pop(ArrayList* this,int index)//14
{
    void* returnAux = NULL;
 ...
 */
ArrayList* al_subList(ArrayList* this,int from,int to)//15
{
    void* returnAux = NULL;
    void* aux = NULL;
    int i;
    ...
    if(this!=NULL)
    {
        if(from>=0 && from<to && from<this->size && to<=this->size)
        {
            returnAux=al_newArrayList();
            if(returnAux!=NULL)
            {
 ...
 */
int al_containsAll(ArrayList* this, ArrayList* this2)//16
{
    int returnAux=-1;
    int i;
    int flag=0;
 ...
 *                  - (0) if ok
 */
int al_sort(ArrayList* this, int (*pFunc)(void* ,void*), int order)//17
{
    int returnAux = -1;
    int i;
    int j;
    ...
    if(this!=NULL && pFunc!=NULL && (order==1 || order==0))
    {
        for(i=0; i<this->size-1; i++)
        {
            ...
            {
                elementoA=al_get(this, i);
                elementoB=al_get(this, j);

                if(order==1)
                {
                    if(pFunc(elementoA,elementoB)==1)
                    {
