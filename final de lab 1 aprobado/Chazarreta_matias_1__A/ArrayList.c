...
ArrayList* al_subList(ArrayList* this,int from,int to)
{
    ...
    if(this != NULL && from < this->len(this) && to <= this->len(this) && from < to && from >= 0)
    {
        returnAux = al_newArrayList();
        if(returnAux != NULL)
        {
...
int al_containsAll(ArrayList* this,ArrayList* this2)
{
    ...
    if(this != NULL && this2 != NULL)
    {
        ...
        else
        {
            for(i=0 ; i<this->len(this); i++)
            {
                control = this->contains(this,this2->get(this,i));
    ...
    if(this != NULL)
    {
        if(pFunc != NULL && (order == 1 || order == 0))
        {
            for(i=0;i<this->len(this);i++)
            {
                ...
                {
                    puntero1 = al_get(this,i);
                    puntero2 = al_get(this,j);

                    if(puntero1 != NULL && puntero2 != NULL)
                    {
                        if(order == 1)
                        {
                            if(pFunc(puntero1,puntero2)== 1)
                            {
                                auxPuntero = this->get(this,i);
                                *(this->pElements+i) = this->get(this,j);
                                *(this->pElements+j) = auxPuntero;
                            }
                        }
                        else
                        {
